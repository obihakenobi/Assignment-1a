...
int main(){
    ...
    printf("%d boxes of Oh Henry    ($0.65 x 48)  = $%0.2f\n", ohHenryBars , henryCost);
    printf("%d boxes of Coffe Crisp ($0.80 x 48)  = $%0.2f\n", CoffeeCrispBars, CoffeeCrispCost);
    printf("%d boxes of Aero        ($0.60 x 48)  = $%0.2f\n", aeroBars , aeroBarsCost);
    printf("%d boxes of Smarties    ($0.70 x 48)  = $%0.2f\n", Smarties, SmartiesCost);
    printf("%d boxed of Crunchie    ($0.75 x 48)  = $%0.2f\n", crunchieBars, crunchieBarsCost);
